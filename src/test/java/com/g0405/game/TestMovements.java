...
public class TestMovements {
    ...
    public void testMovePirates(){
        com.g0405.elements.components.components.characters.components.characters.enemies.Pirates pirates = new com.g0405.elements.components.components.characters.components.characters.enemies.Pirates(10, 20);
        ...
        com.g0405.elements.components.components.characters.components.characters.enemies.Pirates pirates1 = new com.g0405.elements.components.components.characters.components.characters.enemies.Pirates(1, 20);
        pirates1.setState(1);
        pirates1.canPirateMove(30);
        assertEquals(0, pirates1.getState());

        com.g0405.elements.components.components.characters.components.characters.enemies.Pirates pirates2 = new com.g0405.elements.components.components.characters.components.characters.enemies.Pirates(18, 4);
        pirates2.setState(1);
        pirates2.canPirateMove(30);
        assertEquals(0, pirates2.getState());

        com.g0405.elements.components.components.characters.components.characters.enemies.Pirates pirates3 = new com.g0405.elements.components.components.characters.components.characters.enemies.Pirates(12, 4);
        pirates3.setState(0);
        pirates3.canPirateMove(30);
        assertEquals(1, pirates3.getState());

        com.g0405.elements.components.components.characters.components.characters.enemies.Pirates pirates4 = new com.g0405.elements.components.components.characters.components.characters.enemies.Pirates(28, 4);
        pirates4.setState(0);
